...
<head>
    ...
    <style>
        ...
        .request-item span {
            font-weight: bold;
            margin-right: 10px; /* Added some margin to the right of the count */
        }

        .request-item form { /* Added style for the form */
            display: inline; /* Ensure form is inline with other elements */
        }

        .request-item button {  /* Style for the delete button */
            padding: 5px 10px;
            border: none;
            border-radius: 5px;
